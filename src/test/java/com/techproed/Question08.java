...
public class Question08 {
    ...
    public void test1(){
        ...
        softAssert.assertEquals(driver.switchTo().alert().getText(),"I am an alert box!");
        // 5. Accept the pop up
    ...
    public void test2(){
        ...
        softAssert.assertEquals(driver.switchTo().alert().getText(),"Press a button!");
        // 5. Dismiss the pop up
        driver.switchTo().alert().dismiss();

        //6. Verify the “You pressed Cancel!” is displayed
        WebElement uyariMsj=driver.findElement(By.id("confirm-alert-text"));
        softAssert.assertTrue(uyariMsj.isDisplayed());
